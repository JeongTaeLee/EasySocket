...
{
    /// <summary>
    /// <see cref="EasySocket.SocketProxys.ISocketProxy"/>의 소켓에서 데이터를 받았을 시 호출되는 핸들러
    /// </summary>
    ...
    {
        /// <summary>
        /// <see cref="EasySocket.SocketProxys.ISocketProxy"/>이 관리하는 <see cref="System.Net.Sockets.Socket"/> 입니다.
        /// </summary>
        Socket socket { get; }

        /// <summary>
        /// <see cref="EasySocket.SocketProxys.ISocketProxy"/>의 소켓에서 데이터를 받았을 때 호출되는 콜백입니다.
        /// </summary>
        /// <value></value>
        SessionSocketProxyReceiveHandler received { get; set; }

        /// <summary>
        /// <see cref="EasySocket.SocketProxys.ISocketProxy"/>를 시작합니다. 
        /// </summary>
        void Start();
 
        /// <summary>
        /// <see cref="EasySocket.SocketProxys.ISocketProxy"/>를 중지합니다.
        /// </summary>
        void Stop();
    }
}